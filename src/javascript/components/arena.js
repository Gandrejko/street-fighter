...
function createIndicator(fighter, position) {
    ...
    const barShadow = createElement({
        tagName: 'div',
        className: 'arena___health-bar-shadow',
        attributes: { id: `${position}-fighter-indicator-shadow` }
    });
    const criticalHitIndicator = createElement({
        tagName: 'div',
        className: 'arena___fighter-critical-hit-indicator',
        attributes: { id: `${position}-fighter-critical-indicator` }
    });
    const criticalHitBar = createElement({
        tagName: 'div',
        className: 'arena___fighter-critical-hit-bar',
        attributes: { name: fighter.name, id: `${position}-fighter-critical-indicator-shadow` }
    });
